        ...
        <div className="min-h-screen bg-[#0e0f12]">
          <div className="max-w-[1400px] mx-auto px-8 py-8 space-y-8">
            <div className="space-y-2">
              <h1 className={`${heading.className} text-2xl font-semibold text-white/90 tracking-tight`}>Audit Log</h1>
        ...
        <div className="max-w-[1400px] mx-auto px-8 py-8 space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            <div className="bg-white/[0.02] border border-white/[0.08] rounded-xl p-6">
              <p className="text-[10px] text-white/50 tracking-wider uppercase font-medium">Total</p>
              <p className="text-2xl font-semibold text-white/90 mt-2">{total}</p>
            </div>
            <div className="bg-white/[0.02] border border-white/[0.08] rounded-xl p-6">
              <p className="text-[10px] text-white/50 tracking-wider uppercase font-medium">Today</p>
              <p className="text-2xl font-semibold text-white/90 mt-2">{todayCount}</p>
            </div>
            <div className="bg-white/[0.02] border border-white/[0.08] rounded-xl p-6">
              <p className="text-[10px] text-white/50 tracking-wider uppercase font-medium">This Week</p>
              <p className="text-2xl font-semibold text-white/90 mt-2">{weekCount}</p>
            </div>
            <div className="bg-white/[0.02] border border-white/[0.08] rounded-xl p-6">
              <p className="text-[10px] text-white/50 tracking-wider uppercase font-medium">WORM</p>
          ...
          {logs.length > 0 ? (
            ...
            <div className="bg-white/[0.02] border border-white/[0.08] rounded-xl p-12">
              <div className="flex flex-col items-center justify-center text-center space-y-2">
                <h3 className="text-lg font-semibold text-white/90">No audit logs yet</h3>
                <p className="text-sm text-white/60 max-w-md">Administrative actions will appear here</p>
              </div>
            </div>
          )}
        </div>
