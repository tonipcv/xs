...
X-API-Key: xase_pk_...`}
          ...
          <div className="bg-white/[0.03] border border-white/[0.08] rounded-xl p-6">
            ...
            <div className="space-y-4">
              <div className="pl-0">
                <p className="text-sm font-medium text-white mb-1">POST /api/v1/records</p>
                <p className="text-xs text-gray-400">Register a new insurance decision (claims/underwriting)</p>
              </div>
              <div className="pl-0">
                <p className="text-sm font-medium text-white mb-1">GET /api/v1/verify/:id</p>
                <p className="text-xs text-gray-400">Verify cryptographic integrity of a decision</p>
              </div>
              <div className="pl-0">
                <p className="text-sm font-medium text-white mb-1">POST /api/v1/export/:id</p>
                <p className="text-xs text-gray-400">Export offline proof bundle</p>
              </div>
              <div className="pl-0">
                <p className="text-sm font-medium text-white mb-1">POST /api/v1/cron/checkpoint</p>
