...
export const metadata: Metadata = {
  title: 'Voice Data Governance - Supplier Dashboard',
  description: 'Voice dataset management and governance for suppliers',
};
        ...
        <div className="max-w-[1400px] mx-auto px-8 py-8 space-y-8">
          ...
          <div className="grid gap-3 md:grid-cols-2 lg:grid-cols-3">
            <div className="bg-white border border-gray-200 rounded-xl p-5">
              ...
              <p className="text-2xl font-semibold text-gray-900 mt-1 font-mono">{totalDatasets}</p>
              <Link href="/xase/voice/datasets" className="text-xs text-gray-600 hover:text-gray-800 mt-2 inline-block">
                View all →
              </Link>
            </div>
            ...
            <div className="bg-white border border-gray-200 rounded-xl p-5">
              ...
              <p className="text-2xl font-semibold text-gray-900 mt-1 font-mono">{activeLeases}</p>
              <Link href="/xase/voice/leases" className="text-xs text-gray-600 hover:text-gray-800 mt-2 inline-block">
                Manage leases →
              </Link>
            </div>
            ...
            <div className="bg-white border border-gray-200 rounded-xl p-5">
              ...
              <p className="text-2xl font-semibold text-gray-900 mt-1 font-mono">{trainingJobsToday}</p>
              <p className="text-xs text-gray-500">Unique streaming jobs</p>
            </div>

            <div className="bg-white border border-gray-200 rounded-xl p-5">
              <p className="text-xs font-medium text-gray-600">Active Clients</p>
              <p className="text-2xl font-semibold text-gray-900 mt-1 font-mono">{activeClients}</p>
              <Link href="/xase/voice/policies" className="text-xs text-gray-600 hover:text-gray-800 mt-2 inline-block">
                View policies →
              </Link>
            </div>
                    ...
                    {recentDatasets.length > 0 ? (
                      recentDatasets.map((ds) => (
                        ...
                        >
                          <td className="px-4 py-2 text-xs text-gray-800">
                            <Link
                              href={`/xase/voice/datasets/${ds.datasetId}`}
                      ...
                      <tr>
                        <td colSpan={6} className="px-4 py-6 text-center text-xs text-gray-500">
                          No datasets yet.{' '}
                          <Link href="/xase/voice/datasets" className="underline hover:text-gray-800">
