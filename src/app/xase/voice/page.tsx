        ...
        <div className="max-w-[1400px] mx-auto px-8 py-8 space-y-8">
          ...
          <div className="grid gap-3 md:grid-cols-2 lg:grid-cols-3">
            <div className="bg-white border border-gray-200 rounded-xl p-5">
              ...
              <p className="text-2xl font-semibold text-gray-900 mt-1 tabular-nums">{totalDatasets}</p>
            ...
            <div className="bg-white border border-gray-200 rounded-xl p-5">
              ...
              <p className="text-2xl font-semibold text-gray-900 mt-1 tabular-nums">{activeLeases}</p>
            ...
            <div className="bg-white border border-gray-200 rounded-xl p-5">
              ...
              <p className="text-2xl font-semibold text-gray-900 mt-1 tabular-nums">{trainingJobsToday}</p>
