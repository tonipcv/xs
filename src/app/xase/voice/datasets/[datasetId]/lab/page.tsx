      ...
      <AppLayout>
        <div className="min-h-screen bg-gray-50 text-gray-700 p-8">
          <div className="max-w-[900px] mx-auto">
            ...
            <Link className="mt-4 inline-block underline text-gray-800 hover:text-gray-900" href="/xase/voice/client">Back to Dashboard</Link>
          </div>
        </div>
      </AppLayout>
    )
        ...
        <div className="max-w-[1100px] mx-auto px-8 py-8 space-y-8">
          <div className="flex items-center justify-between">
            <div className="space-y-1.5">
              <Link href="/xase/voice/client" className="text-gray-600 hover:text-gray-800 text-sm">← Back to Lab Dashboard</Link>
