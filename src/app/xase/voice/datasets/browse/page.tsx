...
function DatasetBrowserContent() {
  ...
  function navigateToForm(storageLocation: string) {
    ...
    router.push(`/xase/voice/datasets/new?${params.toString()}`)
  }
  ...
  async function addSourceToExistingDataset() {
    ...
    try {
      ...
      router.push(`/xase/voice/datasets/${encodeURIComponent(existingDatasetId.trim())}`)
    } catch (e: any) {
      ...
      <AppLayout>
        <div className="min-h-screen bg-gray-50 flex items-center justify-center">
          <div className="text-center">
            ...
            <Link href="/xase/voice/datasets" className="text-blue-600 hover:underline mt-2 inline-block">
              Go back to datasets
            </Link>
          </div>
        </div>
