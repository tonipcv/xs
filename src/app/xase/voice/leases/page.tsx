...
export const metadata: Metadata = {
  title: 'Lease Management - Xase',
  description: 'Manage training data access leases',
};
        ...
        <div className="max-w-[1400px] mx-auto px-8 py-8 space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            <div className="bg-white border border-white/[0.08] rounded-xl p-6">
              ...
              <p className="text-2xl font-semibold text-gray-900 mt-2 font-mono">{total}</p>
            </div>
            <div className="bg-white border border-white/[0.08] rounded-xl p-6">
              <p className="text-[10px] text-gray-500 tracking-wider uppercase font-medium">Active</p>
              <p className="text-2xl font-semibold text-green-400 mt-2 font-mono">{activeCount}</p>
            </div>
            <div className="bg-white border border-white/[0.08] rounded-xl p-6">
              <p className="text-[10px] text-gray-500 tracking-wider uppercase font-medium">Expired Today</p>
              <p className="text-2xl font-semibold text-gray-600 mt-2 font-mono">{expiredTodayCount}</p>
            </div>
            <div className="bg-white border border-white/[0.08] rounded-xl p-6">
              <p className="text-[10px] text-gray-500 tracking-wider uppercase font-medium">Revoked</p>
              <p className="text-2xl font-semibold text-red-400 mt-2 font-mono">{revokedCount}</p>
            </div>
          </div>

          <div className="bg-white border border-white/[0.08] rounded-xl p-4">
