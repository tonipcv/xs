            ...
            {serializedLeases.length > 0 ? (
                          ...
                          <tr key={lease.leaseId} className="border-b border-gray-200 hover:bg-white">
                            <td className="px-6 py-4">
                              <div className="space-y-1">
                                ...
                                <p className="text-[10px] text-gray-500">{lease.policy.dataset.primaryLanguage}</p>
                              </div>
                            </td>
              ...
              <div className="bg-white border border-gray-200 rounded-xl p-12">
                <div className="flex flex-col items-center justify-center text-center space-y-4">
                  ...
                  <Link
                    href="/xase/training/request-lease"
                    className="px-4 py-2 bg-white text-gray-900 border border-gray-300 rounded text-sm font-medium hover:bg-gray-50 transition-colors"
                  >
                    Request Lease
                  </Link>
                </div>
