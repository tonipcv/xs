        ...
        <div className="max-w-[900px] mx-auto px-8 py-8 space-y-8">
          ...
          <div className="bg-white border border-gray-200 rounded-xl p-6 space-y-4">
            ...
            <div className="flex flex-wrap gap-2 pt-2">
              <Link href="/app/datasets/new" className="inline-flex items-center px-4 py-2 rounded-md bg-gray-900 hover:bg-gray-800 text-white text-sm">
                Connect Provider
              </Link>
              <Button type="button" onClick={()=>router.push(`/app/datasets/${datasetId}`)} variant="outline" className="border-gray-300 text-gray-700 hover:bg-gray-50">
                Back to Dataset
              </Button>
            </div>
          </div>
