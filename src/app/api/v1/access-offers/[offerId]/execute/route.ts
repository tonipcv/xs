  ...
  try {
    ...
    const policy = await prisma.accessPolicy.create({
      data: {
        ...
        canStream: typeof offer.constraints === 'object' && offer.constraints !== null && 'canStream' in offer.constraints ? Boolean(offer.constraints.canStream) : true,
        canBatchDownload: typeof offer.constraints === 'object' && offer.constraints !== null && 'canBatchDownload' in offer.constraints ? Boolean(offer.constraints.canBatchDownload) : false,
        allowedColumns: [],
        deniedColumns: [],
        status: 'ACTIVE',
      },
